 ...
 * каждый раз, когда сумма денег заработанных за продукт, за минуту больше, чем MAX_SUM_PER_MINUTE
 */
public class SumPurchaseAlert {
    public static final String PURCHASE_TOPIC_NAME = "purchases";
    public static final String PRODUCT_TOPIC_NAME = "products";
    public static final String RESULT_TOPIC = "product_price_alerts-dsl";
    private static final double MAX_SUM_PER_MINUTE = 3000D;
    ...
    public static Topology buildTopology(SchemaRegistryClient client, Map<String, String> serDeConfig) {
        ...
        purchasesStream
                .leftJoin(
                        ...
                        SumPurchaseAlert::joinProduct // указываем, как джоинить
                )
                ...
                .map((key, val) -> {
                    ...
                    record.put("total_sum_per_minute", val);
    ...
    private static GenericRecord joinProduct(GenericRecord purchase, GenericRecord product) {
